<div align="center">
  ...
  <h2>Lista de exercícios de Java</h2>
</div>
<div>
  <h4>Questão 1</h4>
  ...
  <h4>Questão 3</h4>
  <p>Escreva um programa que lê o nome de 5 frutas e armazena num carrinho de compras. Ao final da entrada dos 5 itens, exiba a lista completa. Exemplo: banana, maçã, abacaxi, melão, mamão.</p>
